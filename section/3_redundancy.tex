...
\Tool instruments the program to record \textit{inputs} values at run time.
...
\[
\Scale[0.8]{
	Redundancy(I) =  \frac{EditDistance(SeqA, SeqB) - |Length(SeqA) - Length(SeqB)|}{max(Length(SeqA), Length(SeqB))}
}
\]
