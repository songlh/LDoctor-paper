...
It contains a cross-loop redundant bug --- 
the \texttt{for} loop starting on line 7 could be executed for many times,
applied to many \texttt{source} strings slightly different from each other
with a lot of
redundant computation.
Below, we use it to demonstrate how we identify \texttt{input}s.
...
with the workload, memoization is unlikely to help save much computation and
