...
\Tool suggests how to fix an inefficient loop to developers.
...
this
as an I/O related redundancy problem and suggests batching as a potential fix
...
Generating the exact patch is out of the scope of \Tool.
