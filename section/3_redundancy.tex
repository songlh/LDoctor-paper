...
It is difficult to directly produce patches with correctness guarantee for
all inefficient loops.
What \Tool aims to do is to provide fix-strategy suggestion to developers.
This process is straightforward following our taxonomy discussion in 
Section \ref{sec:study}, as there is often one or two natural fix strategies for
each sub-category of root causes.
