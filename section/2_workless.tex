\section{\Tool design}
\label{sec:design}
\Tool is composed of a series of analysis routines that
identify whether a given loop belongs to any root cause type discussed in
...
will not be able to provide all the needed information. However, 
